...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../node_modules/riot/src/globals.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SLOTS_KEY_SYMBOL = exports.TEMPLATE_KEY_SYMBOL = exports.ATTRIBUTES_KEY_SYMBOL = exports.IS_DIRECTIVE = exports.PLUGINS_SET = exports.DOM_COMPONENT_INSTANCE_PROPERTY = exports.COMPONENTS_IMPLEMENTATION_MAP = void 0;
...
exports.SLOTS_KEY_SYMBOL = SLOTS_KEY_SYMBOL;
exports.TEMPLATE_KEY_SYMBOL = TEMPLATE_KEY_SYMBOL;
exports.ATTRIBUTES_KEY_SYMBOL = ATTRIBUTES_KEY_SYMBOL;
...
},{}],"../../node_modules/bianco.attr/index.next.js":[function(require,module,exports) {
"use strict";
...
function parseNodes(els, name, method) {
  ...
  return normalize((0, _bianco.default)(els).map(el => {
...
function set(els, name, value) {
  ...
  (0, _bianco.default)(els).forEach(el => {
...
},{"bianco.dom-to-array":"../../node_modules/bianco.dom-to-array/index.next.js"}],"../../node_modules/riot/src/utils/checks.js":[function(require,module,exports) {
"use strict";
...
},{}],"../../node_modules/riot/src/utils/misc.js":[function(require,module,exports) {
"use strict";
...
exports.evaluateAttributeExpressions = evaluateAttributeExpressions;
...
function callOrAssign(source) {
  return (0, _checks.isFunction)(source) ? source.prototype && source.prototype.constructor ? new source() : source() : source;
}
/**
...
function normalizeAttribute(_ref3) {
  var name = _ref3.name,
      value = _ref3.value;
  return {
...
function defineProperties(source, properties, options) {
  Object.entries(properties).forEach(function (_ref4) {
...
},{"./checks":"../../node_modules/riot/src/utils/checks.js"}],"../../node_modules/riot/src/utils/dom.js":[function(require,module,exports) {
"use strict";
...
var _bianco = require("bianco.attr");
...
function DOMattributesToObject(element) {
  return Array.from(element.attributes).reduce(function (acc, attribute) {
    var attr = (0, _misc.normalizeAttribute)(attribute);
...
function getName(element) {
  return (0, _bianco.get)(element, _globals.IS_DIRECTIVE) || element.tagName.toLowerCase();
}
},{"../globals":"../../node_modules/riot/src/globals.js","bianco.attr":"../../node_modules/bianco.attr/index.next.js","./misc":"../../node_modules/riot/src/utils/misc.js"}],"../../node_modules/@riotjs/dom-bindings/dist/esm.dom-bindings.js":[function(require,module,exports) {
"use strict";
...
exports.expressionTypes = exports.bindingTypes = void 0;
...
const EachBinding = Object.seal({
  ...
  unmount() {
    Array.from(this.childrenMap.values()).forEach(({
      tag,
      context
    }) => {
...
function setAllAttributes(node, attributes) {
  Object.entries(attributes).forEach(([name, value]) => attributeExpression(node, {
    name
  }, value));
}
/**
...
function create$3(node, {
  expressions
}) {
  return { ...flattenCollectionMethods(expressions.map(expression => create$2(node, expression)), ['mount', 'update', 'unmount'])
  };
}
/**
...
function create$5(root, binding) {
  ...
  return (bindings[type] || bindings[SIMPLE])(node, { ...binding,
...
},{"bianco.dom-to-array":"../../node_modules/bianco.dom-to-array/index.next.js"}],"../../node_modules/riot/src/core/slots.js":[function(require,module,exports) {
"use strict";
...
var _bianco = _interopRequireDefault(require("bianco.query"));

var _bianco2 = require("bianco.attr");

var _domBindings = require("@riotjs/dom-bindings");
...
function createSlot(root, node, _ref) {
  ...
  return { ...Slot,
    node: node,
    name: name,
    template: templateData && (0, _domBindings.template)(templateData.html, templateData.bindings).createDOM(root)
  };
}
/**
...
function createSlots(root, slots) {
  var slotNodes = (0, _bianco.default)('slot', root);
  var slotsBindings = slotNodes.map(function (node) {
    var name = (0, _bianco2.get)(node, 'name') || 'default';
...
},{"bianco.query":"../../node_modules/bianco.query/index.next.js","bianco.attr":"../../node_modules/bianco.attr/index.next.js","@riotjs/dom-bindings":"../../node_modules/@riotjs/dom-bindings/dist/esm.dom-bindings.js"}],"../../node_modules/riot/src/core/css-manager.js":[function(require,module,exports) {
"use strict";
...
var styleNode = WIN && function () {
  ...
  (0, _bianco.set)(newNode, 'type', 'text/css');
...
exports.default = _default;
},{"../utils/dom":"../../node_modules/riot/src/utils/dom.js","bianco.attr":"../../node_modules/bianco.attr/index.next.js"}],"../../node_modules/curri/index.next.js":[function(require,module,exports) {
"use strict";
...
},{}],"../../node_modules/riot/src/core/component.js":[function(require,module,exports) {
"use strict";
...
exports.enhanceComponentAPI = enhanceComponentAPI;
...
var _cssManager = _interopRequireDefault(require("./css-manager"));

var _curri = _interopRequireDefault(require("curri"));
...
var COMPONENT_CORE_HELPERS = Object.freeze({
  // component helpers
  $: function $(selector) {
    return (0, _bianco.default)(selector, this.root)[0];
  },
  $$: function $$(selector) {
    return (0, _bianco.default)(selector, this.root);
  }
});
var COMPONENT_LIFECYCLE_METHODS = Object.freeze({
  shouldUpdate: _misc.noop,
  onBeforeMount: _misc.noop,
  onMounted: _misc.noop,
  onBeforeUpdate: _misc.noop,
  onUpdated: _misc.noop,
  onBeforeUnmount: _misc.noop,
  onUnmounted: _misc.noop
});
...
function defineComponent(_ref3) {
  var css = _ref3.css,
      ...
      name = _ref3.name;
  var componentAPI = (0, _misc.callOrAssign)(exports) || {};
  var components = createSubcomponents(componentAPI.components); // add the component css into the DOM

  if (css && name) _cssManager.default.add(name, css);
  return (0, _curri.default)(enhanceComponentAPI)((0, _misc.defineProperties)( // set the component defaults without overriding the original component API
  (0, _misc.defineDefaults)(componentAPI, { ...COMPONENT_LIFECYCLE_METHODS,
    state: {}
  }), {
    ...
    name: name,
    css: css,
    template: template ? template(_domBindings.template, _domBindings.expressionTypes, _domBindings.bindingTypes, function (name) {
      return components[name] || _globals.COMPONENTS_IMPLEMENTATION_MAP.get(name);
...
function evaluateProps(element) {
  ...
  var currentProps = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

  if (attributeExpressions.length) {
    return scope ? (0, _misc.evaluateAttributeExpressions)(attributeExpressions, scope) : currentProps;
  }

  return (0, _dom.DOMattributesToObject)(element);
}
/**
...
function createAttributeBindings(attributes) {
  return (0, _domBindings.template)(null, [{
    expressions: (attributes || []).map(function (attr) {
      return {
        type: _domBindings.expressionTypes.ATTRIBUTE,
        ...attr
      };
    })
  }]);
...
function createSubcomponents() {
  ...
  return Object.entries((0, _misc.callOrAssign)(components)).reduce(function (acc, _ref4) {
    var _ref5 = _slicedToArray(_ref4, 2),
        key = _ref5[0],
        value = _ref5[1];

    acc[(0, _misc.camelToDashCase)(key)] = createComponent(value);
    return acc;
  }, {});
}
/**
...
function runPlugins(component) {
  return _toConsumableArray(_globals.PLUGINS_SET).reduce(function (c, fn) {
    return fn(c) || c;
  }, component);
}
/**
...
function addCssHook(element, name) {
  if ((0, _dom.getName)(element) !== name) {
    (0, _bianco2.set)(element, 'is', name);
  }
}
/**
...
function enhanceComponentAPI(component, _ref6) {
  ...
  var initialProps = (0, _misc.callOrAssign)(props);
  return (0, _misc.autobindMethods)(runPlugins((0, _misc.defineProperties)(Object.create(component), {
    mount: function mount(element) {
      var state = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var parentScope = arguments.length > 2 ? arguments[2] : undefined;
      this.props = Object.freeze({ ...initialProps,
        ...evaluateProps(element, attributes, parentScope)
      });
      this.state = computeState(this.state, state);
      this[_globals.TEMPLATE_KEY_SYMBOL] = this.template.createDOM(element).clone();
      this[_globals.ATTRIBUTES_KEY_SYMBOL] = attributeBindings.createDOM(element).clone(); // link this object to the DOM node

      element[_globals.DOM_COMPONENT_INSTANCE_PROPERTY] = this; // add eventually the 'is' attribute

      component.name && addCssHook(element, component.name); // define the root element

      (0, _misc.defineProperty)(this, 'root', element); // before mount lifecycle event

      this.onBeforeMount(this.props, this.state); // handlte the template and its attributes

      this[_globals.ATTRIBUTES_KEY_SYMBOL].mount(element, parentScope);

      this[_globals.TEMPLATE_KEY_SYMBOL].mount(element, this); // create the slots and mount them


      this[_globals.SLOTS_KEY_SYMBOL] = (0, _slots.default)(element, slots || []).mount(parentScope);
    ...
    update: function update() {
      ...
      if (parentScope) {
        this[_globals.ATTRIBUTES_KEY_SYMBOL].update(parentScope);

        this[_globals.SLOTS_KEY_SYMBOL].update(parentScope);
      }

      this[_globals.TEMPLATE_KEY_SYMBOL].update(this);
    ...
    unmount: function unmount(preserveRoot) {
      ...
      this[_globals.ATTRIBUTES_KEY_SYMBOL].unmount();

      this[_globals.SLOTS_KEY_SYMBOL].unmount();

      this[_globals.TEMPLATE_KEY_SYMBOL].unmount(this, !preserveRoot);

      this.onUnmounted(this.props, this.state);
      return this;
    }
  })), Object.keys(component).filter(function (prop) {
    return (0, _checks.isFunction)(component[prop]);
  }));
}
/**
...
function mountComponent(element, initialProps, componentName) {
  var name = componentName || (0, _dom.getName)(element);
  if (!_globals.COMPONENTS_IMPLEMENTATION_MAP.has(name)) (0, _misc.panic)("The component named \"".concat(name, "\" was never registered"));

  var component = _globals.COMPONENTS_IMPLEMENTATION_MAP.get(name)({
    props: initialProps
  });

  return component.mount(element);
}
},{"../globals":"../../node_modules/riot/src/globals.js","../utils/dom":"../../node_modules/riot/src/utils/dom.js","../utils/misc":"../../node_modules/riot/src/utils/misc.js","@riotjs/dom-bindings":"../../node_modules/@riotjs/dom-bindings/dist/esm.dom-bindings.js","bianco.query":"../../node_modules/bianco.query/index.next.js","./slots":"../../node_modules/riot/src/core/slots.js","./css-manager":"../../node_modules/riot/src/core/css-manager.js","curri":"../../node_modules/curri/index.next.js","../utils/checks":"../../node_modules/riot/src/utils/checks.js","bianco.attr":"../../node_modules/bianco.attr/index.next.js"}],"../../node_modules/cumpa/index.next.js":[function(require,module,exports) {
"use strict";
...
},{}],"../../node_modules/riot/src/riot.js":[function(require,module,exports) {
"use strict";
...
exports.__ = exports.version = void 0;
...
var _cumpa = _interopRequireDefault(require("cumpa"));

var _cssManager = _interopRequireDefault(require("./core/css-manager"));
...
var DOM_COMPONENT_INSTANCE_PROPERTY = globals.DOM_COMPONENT_INSTANCE_PROPERTY,
    COMPONENTS_IMPLEMENTATION_MAP = globals.COMPONENTS_IMPLEMENTATION_MAP,
    PLUGINS_SET = globals.PLUGINS_SET;
/**
 * Riot public api
 */
...
function register(name, _ref) {
  var css = _ref.css,
      template = _ref.template,
      exports = _ref.exports;
  if (COMPONENTS_IMPLEMENTATION_MAP.has(name)) (0, _misc.panic)("The component \"".concat(name, "\" was already registered"));
  COMPONENTS_IMPLEMENTATION_MAP.set(name, (0, _component.createComponent)({
    name: name,
    css: css,
    template: template,
    exports: exports
...
function unregister(name) {
  if (!COMPONENTS_IMPLEMENTATION_MAP.has(name)) (0, _misc.panic)("The component \"".concat(name, "\" was never registered"));
  COMPONENTS_IMPLEMENTATION_MAP.delete(name);

  _cssManager.default.remove(name);
...
function mount(selector, initialProps, name) {
  return (0, _bianco.default)(selector).map(function (element) {
    return (0, _component.mountComponent)(element, initialProps, name);
  });
}
/**
...
function install(plugin) {
  if (!(0, _checks.isFunction)(plugin)) (0, _misc.panic)('Plugins must be of type function');
  if (PLUGINS_SET.has(plugin)) (0, _misc.panic)('This plugin was already install');
...
function uninstall(plugin) {
  if (!PLUGINS_SET.has(plugin)) (0, _misc.panic)('This plugin was never installed');
...
function component(implementation) {
  return function (el, props) {
    return (0, _cumpa.default)(function (c) {
      return c.mount(el);
    }, function (c) {
      return c({
        props: props
      });
    }, _component.createComponent)(implementation);
  };
}
/** @type {string} current riot version */


var version = 'WIP'; // expose some internal stuff that might be used from external tools

exports.version = version;
var __ = {
  cssManager: _cssManager.default,
  defineComponent: _component.defineComponent,
  globals: globals
};
exports.__ = __;
},{"./globals":"../../node_modules/riot/src/globals.js","./core/component":"../../node_modules/riot/src/core/component.js","bianco.query":"../../node_modules/bianco.query/index.next.js","cumpa":"../../node_modules/cumpa/index.next.js","./core/css-manager":"../../node_modules/riot/src/core/css-manager.js","./utils/checks":"../../node_modules/riot/src/utils/checks.js","./utils/misc":"../../node_modules/riot/src/utils/misc.js"}],"../../node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../../node_modules/process/browser.js"}],"../../node_modules/feature.js/feature.js":[function(require,module,exports) {
/*!
...
var _default = anime;
exports.default = _default;
},{}],"../riot/app-tag.riot":[function(require,module,exports) {
module.exports = "/app-tag.488bdd0a.riot";
},{}],"../riot/raw-html.riot":[function(require,module,exports) {
module.exports = "/raw-html.400de67d.riot";
...
var _appTag = _interopRequireDefault(require("../riot/app-tag.riot"));
...
riot.register('app-tag', _appTag.default);
riot.register('raw-html', _rawHtml.default);
riot.mount('[data-riot]');
console.log("feature.touch = ".concat(feature.touch)); // anime.js サンプル

var animeSample = (0, _animeEs.default)({
  targets: '.js-anime',
  translateX: 240,
  rotate: 360,
  duration: 800,
...
},{"riot":"../../node_modules/riot/src/riot.js","jquery":"../../node_modules/jquery/dist/jquery.js","feature.js":"../../node_modules/feature.js/feature.js","../../node_modules/animejs/lib/anime.es.js":"../../node_modules/animejs/lib/anime.es.js","../riot/app-tag.riot":"../riot/app-tag.riot","../riot/raw-html.riot":"../riot/raw-html.riot"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
