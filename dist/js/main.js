...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../node_modules/riot/riot.js":[function(require,module,exports) {
var define;
...
},{}],"../../node_modules/riot-animore/node_modules/animejs/anime.min.js":[function(require,module,exports) {
var global = arguments[3];
var define;
/*
 2017 Julian Garnier
...
},{}],"../../node_modules/riot-animore/lib/helpers.js":[function(require,module,exports) {
"use strict";
...
exports.domToArray = domToArray;
exports.getIndex = getIndex;
exports.getProps = getProps;
exports.inheritFromParent = inheritFromParent;
...
const riotExtend = _riot.default.util.misc.extend;
const slice = [].slice;
const extend = riotExtend;
/**
...
function onMount(root, opts) {
  ...
  (0, _animejs.default)(extend({}, opts.mount, {
    targets: root,
...
function inheritFromParent(tag) {
...
},{"animejs":"../../node_modules/riot-animore/node_modules/animejs/anime.min.js","riot":"../../node_modules/riot/riot.js"}],"../../node_modules/riot-animore/lib/animore.js":[function(require,module,exports) {
"use strict";
...
var _default = _riot.default.tag('animore', '<yield/>', function () {
  let prevProps, index;
  /**
   * Internal helpers
   */
  ...
  function updateIndex(root) {
    index = (0, _helpers.getIndex)(root);
  }
  /**
  ...
  function doFlip(root, flipOpts) {
    const newProps = (0, _helpers.getProps)(root);
    (0, _animejs.default)((0, _helpers.extend)(typeof flipOpts === 'object' ? flipOpts : {}, {
      targets: root,
  ...
  const lifecycle = {
    onCreate() {
      ...
      (0, _helpers.inheritFromParent)(this);
      if (this.opts.mount) this.root.style.visibility = 'hidden';
    },

    onMount() {
      updateIndex(this.root);
      (0, _helpers.onMount)(this.root, this.opts);
    },

    onUpdate() {
      if (this.opts.update) prevProps = (0, _helpers.getProps)(this.root);
      (0, _helpers.inheritFromParent)(this);
    },
    ...
    onBeforeUnmount() {
      ...
      (0, _animejs.default)((0, _helpers.extend)({}, this.opts.unmount, {
        targets: clone,
        complete: () => {
  ...
  Object.keys(lifecycle).forEach(event => lifecycle[event] = lifecycle[event].bind(this)); // lifecycle listeners

  this.one('mount', lifecycle.onMount).on('updated', lifecycle.onUpdated).on('unmount', lifecycle.onUnmount).one('before-unmount', lifecycle.onBeforeUnmount); // oncreate callback

  lifecycle.onCreate();

  if (this.opts.update) {
    if (this.parent) this.parent.on('update', lifecycle.onUpdate);else this.on('update', lifecycle.onUpdate);
  }
});

exports.default = _default;
},{"riot":"../../node_modules/riot/riot.js","animejs":"../../node_modules/riot-animore/node_modules/animejs/anime.min.js","./helpers":"../../node_modules/riot-animore/lib/helpers.js"}],"../../node_modules/riot-animore/lib/index.js":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "animate", {
  enumerable: true,
  get: function () {
    return _animore.default;
  }
});

var _animore = _interopRequireDefault(require("./animore"));
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./animore":"../../node_modules/riot-animore/lib/animore.js","./helpers":"../../node_modules/riot-animore/lib/helpers.js"}],"../../node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{"buffer":"../../node_modules/buffer/index.js"}],"../../node_modules/feature.js/feature.js":[function(require,module,exports) {
/*!
...
exports.default = _default;
},{"./finally":"../../node_modules/promise-polyfill/src/finally.js"}],"../../node_modules/scroll-out/lib/index.js":[function(require,module,exports) {
'use strict';
